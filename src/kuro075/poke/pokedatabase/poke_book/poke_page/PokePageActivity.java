...
public class PokePageActivity extends PokeBookMenuActivity{
	...
	public static void startThisActivity(Context context,String name){
		...
		DataStore.DataTypes.POKEMON.getHistoryStore().addPageData(name);//履歴に保存
		context.startActivity(intent);
	}
	
	/**
	 * このアクティビティーを履歴に保存せずstartさせる
	 * @param context
	 * @param name
	 */
	public static void startThisActivityWithoutHistory(Context context,String name){
