...
public class BasicInformationLayout extends LinearLayout{
	...
	private void setAllData(){
    	...
    	//高さ重さ
		Height.setText(PokeDataManager.ViewableInformations.HEIGHT.getInformation(poke));
    	Weight.setText(PokeDataManager.ViewableInformations.WEIGHT.getInformation(poke));
    	//けたぐりの威力
    	StringBuilder sb=new StringBuilder();
    	sb.append("(けたぐり:");
    	sb.append(PokeDataManager.ViewableInformations.KETAGURI_KUSAMUSUBI.getInformation(poke));
    	sb.append(")");
    	Ketaguri.setText(new String(sb));
    	//孵化歩数
    	HatchingStep.setText(PokeDataManager.ViewableInformations.HATCHING_STEP.getInformation(poke));
    	...
    	//その他データ
    	FinalEx.setText(PokeDataManager.ViewableInformations.FINAL_EX.getInformation(poke));
    	...
    	EGet.setText(PokeDataManager.ViewableInformations.EASE_GET.getInformation(poke));
    	BasicEx.setText(PokeDataManager.ViewableInformations.BASIC_EX.getInformation(poke));
    	Natsuki.setText(PokeDataManager.ViewableInformations.INITIAL_NATSUKI.getInformation(poke));
    }
}
