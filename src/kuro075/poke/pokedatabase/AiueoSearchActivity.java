...
public class AiueoSearchActivity extends BookMenuActivity{
	...
	private void pushButtonName(String head){
		Utility.log(TAG, "pushButtonName");
		...
		startSearchResultActivity(PokeSearchableInformations.NAME.getDefaultTitle(head),if_list.toArray(new String[0]));
	}
	/**
	 * 検索結果アクティビティーを開始
	 * @param head
